...
export const roleNav: Record<Role, NavItem[]> = {
  admin: [
    ...
    { to: '/admin/especialidades', label: 'Especialidades', icon: 'local_hospital' },
  ...
  doctor: [
    ...
    { to: '/medico/consultas', label: 'Ficha clínica', icon: 'monitor_heart' },
  ...
  patient: [
    ...
    { to: '/paciente/especialidades', label: 'Especialidades', icon: 'local_hospital' },
